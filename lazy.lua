...
return {
...

  {
    ...
    optional = true,
    keys = {
      { "<leader>hs", function() hs().pick() end,         desc = "Helm: insert schema template", ft = { "yaml", "helm" } },
      { "<leader>hS", function() hs().generate() end,     desc = "Helm: sync SchemaStore templates" },
      { "<leader>hk", function() hs().sync_k8s() end,     desc = "Helm: sync core k8s templates (yannh)" },
      { "<leader>hc", function() hs().prompt_crd() end,   desc = "Helm: add CRD from file or URL" },
      { "<leader>hC", function() hs().sync_cluster() end, desc = "Helm: sync CRDs from current kubectl context" },
      { "<leader>hx", function() hs().clear() end,        desc = "Helm: clear schemas" },
    },
  },
